...
@section('title', 'Create Room Type - Hotel Reservation System')
...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-serif font-bold text-primary">Create New Room Type</h1>
    <p class="text-gray-500 mt-1">Add a new room type to your hotel</p>
</div>
    ...
    <form action="{{ route('room-types.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="number" name="price_per_night" id="price_per_night" value="{{ old('price_per_night') }}" min="0" step="0.01"
