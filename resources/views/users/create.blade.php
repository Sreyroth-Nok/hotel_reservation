...
@section('title', 'Create User - Hotel Reservation System')
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl border border-luxury-border overflow-hidden shadow-lg">
        ...
        <div class="px-8 py-6 border-b border-luxury-border bg-gradient-to-r from-primary to-primary-dark">
            <h2 class="text-2xl font-serif font-bold text-white">Add New User</h2>
            <p class="text-gray-300 mt-1">Create a new administrator or staff member account</p>
        </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="p-8">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="relative flex cursor-pointer rounded-lg border border-luxury-border p-6 hover:border-accent transition-colors">
                        <input type="radio" name="role" value="admin" {{ old('role') === 'admin' ? 'checked' : '' }} class="sr-only peer" required>
                    ...
                    <label class="relative flex cursor-pointer rounded-lg border border-luxury-border p-6 hover:border-accent transition-colors">
                        ...
                        <div class="flex items-start space-x-4 w-full">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">Limited access for day-to-day operations</p>
                            </div>
                        </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-luxury-border">
                <a href="{{ route('users.index') }}" class="px-6 py-3 border-2 border-luxury-border text-gray-700 rounded-lg hover:bg-luxury-bg transition-colors font-medium">
                    Cancel
                </a>
